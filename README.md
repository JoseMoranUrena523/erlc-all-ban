...
## What is this?
This automation detects when a Roblox user joins your ER:LC private server with a username starting with "all". It then sends them a private message and proceeds to ban them. (hasn't been tested in a private server yet so it can be buggy).
